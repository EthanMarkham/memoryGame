...
export default function GameInfo(props) {
  ...
  const {toggleLeaveHelp, toggleLableHelp, toggleGameLabels, handleQuit} = state.actions;
  ...
  else if (nextTurn === me) turnMessage = "You're up!"
        ...
        <div className="gameControl">
          <div className="gameButton">
            <button
              ...
              className="btn"
              onClick={() => toggleGameLabels(!state.labels.card)}>
