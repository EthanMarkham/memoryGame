      ...
      <div className="gameInfo">
        ...
        <div className="gameControl">
          <div className="gameButton">
            <button
              id="showLabels"
              onMouseOver={() => dispatch({type: "LABEL_INFO", payload:  {value: true}})}
              onMouseLeave={() => dispatch({type: "LABEL_INFO", payload:  {value: false}})}
              className="btn"
          ...
          <div
            ...
            <button
              className="btn"
              onMouseOver={() => dispatch({type: "LEAVE_INFO", payload: {value: true}})}
              onMouseLeave={() => dispatch({type: "LEAVE_INFO", payload:  {value: false}})}
